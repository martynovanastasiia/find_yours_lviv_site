L.Control.Dialog = L.Control.extend({
  ...
  _initLayout: function(){
    ...
    var innerContainer = this._innerContainer = L.DomUtil.create('div', 'place-card');

    var closeNode = this._closeNode = L.DomUtil.create('div', 'close-button');
    var closeIcon = L.DomUtil.create('img', '');
    closeIcon.src='../icons/cross.svg';
    closeIcon.alt = 'close-button';
    closeNode.appendChild(closeIcon);
    L.DomEvent.on(closeNode, 'click', this._handleClose, this);

    var contentNode = this._contentNode = L.DomUtil.create('div', "row");
